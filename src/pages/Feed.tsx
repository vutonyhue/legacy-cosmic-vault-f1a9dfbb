  ...
  return <div className="min-h-screen bg-background">
      ...
      <div className="container max-w-7xl mx-auto py-4 sm:py-8 px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-[320px,1fr,380px] gap-6">
          ...
          {/* Main Feed */}
          <main className="max-w-2xl mx-auto w-full px-[100px]">
            {currentUserId && <CreatePost onPostCreated={fetchPosts} />}
            
            {!currentUserId && <div className="mb-6 p-4 bg-primary/5 border border-primary/20 rounded-lg text-center">
            ...
            {loading ? <div className="space-y-4">
              ...
              </div> : posts.map(post => <PostCard key={post.id} post={post} currentUserId={currentUserId} onPostDeleted={fetchPosts} />)}
          </main>
